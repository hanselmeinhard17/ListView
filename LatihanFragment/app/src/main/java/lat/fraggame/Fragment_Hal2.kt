 ...
 * Use the [Fragment_Hal2.newInstance] factory method to
 * create an instance of this fragment.
 */
class Fragment_Hal2 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment__hal2, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        _tvHasil.setText(MainActivity.playerScore.score.toString())
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment Fragment_Hal2.
         */
